...
class Ui_SecDialog(object):
    def setupUi(self, SecDialog):
        ...
        self.B4_AWarping.setGeometry(QtCore.QRect(390, 145, 101, 28))
        ...
        self.After_AWarping.setGeometry(QtCore.QRect(390, 195, 101, 28))
        ...
        self.After_CFiltering.setGeometry(QtCore.QRect(390, 245, 101, 28))
